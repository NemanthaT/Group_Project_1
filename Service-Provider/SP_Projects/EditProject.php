...
<head>
    ...
    <title>EDSA Lanka Consultancy - Project Details</title>
...
<body>
    <div class="container">
        ...
        <div class="sidebar">
            ...
            <ul class="menu">
                <li><a href="../SP_Dashboard/SPDash.php"><button><img src="../images/dashboard.png" alt="Dashboard"><span>Dashboard</span></button></a></li>
                <li><a href="../SP_Appointment/App.php"><button><img src="../images/appointment.png" alt="Appointment"><span>Appointment</span></button></a></li>
                <li><a href="../SP_Message/Message.php"><button><img src="../images/message.png" alt="Message"><span>Message</span></button></a></li>
                <li><a href="../SP_Projects/Project.php"><button><img src="../images/project.png" alt="Project"><span>Project</span></button></a></li>
                <li><a href="../SP_Bill/Bill.php"><button><img src="../images/bill.png" alt="Bill"><span>Bill</span></button></a></li>
                <li><a href="../SP_Forum/Forum.php"><button><img src="../images/forum.png" alt="Forum"><span>Forum</span></button></a></li>
                <li><a href="../SP_KnowledgeBase/KB.php"><button><img src="../images/knowledgebase.png" alt="KnowledgeBase"><span>KnowledgeBase</span></button></a></li>
            </ul>
        </div>
